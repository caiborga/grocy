    ...
    <main class="landing-page">
        <header class="topbar">
            <div class="topbar-inner">
                ...
                <nav class="topbar-nav">
                    ...
                    <router-link to="/register" class="topbar-link topbar-link-primary">
                        Registrieren
                    </router-link>
                </nav>
            </div>
        ...
        <section class="hero-section">
            <div class="hero-copy">
                ...
                <p class="hero-text">
                    Grocy hilft dir, Einkaufslisten übersichtlich zu organisieren, gemeinsam im Haushalt zu nutzen
                    und beim Einkauf immer den Überblick zu behalten.
                </p>

                <div class="hero-actions">
                    <el-button type="primary" size="large" round @click="scrollToFeatures">
                        Features ansehen
                    </el-button>
                </div>
            </div>
        ...
        <section ref="featuresSection" class="features-wrapper">
            <div class="section-heading">
                ...
                <p>
                    Von gemeinsamen Listen bis zu Rollen und Einladungen: Grocy bringt Ordnung in den Einkaufsalltag.
                </p>
            </div>
...
.hero-visual::before {
    ...
    z-index: -1;
    border-radius: 46px;
    background: linear-gradient(135deg, rgba(59, 130, 246, 0.24), rgba(147, 197, 253, 0.05));
    filter: blur(6px);
}
...
.feature-icon {
    ...
    border-radius: 18px;
    color: #2563eb;
    background: linear-gradient(135deg, rgba(59, 130, 246, 0.16), rgba(96, 165, 250, 0.1));
